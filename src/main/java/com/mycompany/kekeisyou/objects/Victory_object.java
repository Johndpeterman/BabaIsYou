 ...
 */
public class Victory_object extends GameObject {
    //pink
    ...
    public Victory_object(float x, float y, Handler handler, ObjectId id) {
        super(x, y, id);
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(texture.victory_sprite[0], (int)x, (int)y, null);
