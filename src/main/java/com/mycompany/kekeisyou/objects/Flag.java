...
public class Flag extends GameObject {
    ...
    private void Collision(LinkedList<GameObject> object) {
        ...
        for (int i = 0; i < handler.object.size(); i++) {
            ...
            if (tempObject.getId() == ObjectId.Wall) { //checking if the flag is colliding with the wall
            ...
            if (tempObject.getId() == ObjectId.Is_text) { //checking if the flag is colliding with the is_text
            ...
            if (tempObject.getId() == ObjectId.Stop_text) { //checking if the flag is colliding with the stop_text
            ...
            if (tempObject.getId() == ObjectId.Not_text) { //checking if the flag is colliding with the win_text
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(texture.flag_sprite[0], (int)x, (int)y, null);
