 ...
 */
public class Win_text extends GameObject {
    //pink
    ...
    public Win_text(float x, float y, Handler handler, ObjectId id) {
        super(x, y, id);
    ...
    private void Collision(LinkedList<GameObject> object) {
        ...
        for (int i = 0; i < handler.object.size(); i++) {
            ...
            if (tempObject.getId() == ObjectId.Is_text) { //checking if the  is colliding with the block Wall_textblock
                ...
                ///////
                if (getBoundsRight().intersects(tempObject.getBoundsLeft())) { //if wall text colliding with is text
            ...
            if (tempObject.getId() == ObjectId.Flag_text) { //checking if the player is colliding with the block Stop_textblock
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(texture.win_text_sprite[0], (int)x, (int)y, null);
        /*
